...
Prior to implementing this ECS engine, I implemented an [OOP based engine](https://github.com/CLPolo/cpp-OOP-game-engine), and the contrast in the experiences is stark. 
